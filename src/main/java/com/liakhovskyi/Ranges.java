...
public class Ranges {
    ...
    public static String ranging(int[] array) {
    ...
    private static void longRange(StringBuilder result, int i, int k, int[] copiedArray){
        result.append("[" + copiedArray[i - k] + " " + copiedArray[i] + "]");
    }

    private static void shortRange(StringBuilder result, int i, int[] copiedArray){
        result.append("[" + copiedArray[i] + "]");
    }
}
